...
export const AUTHORS: Author[] = [
  {
    ...
    bio: [
      ...
      'He has led organic strategy as SEO Manager at Makula Technology, a Berlin-based B2B industrial and field-service SaaS platform serving asset-heavy manufacturing. There he owned end-to-end SEO across technical, content and off-page work, earning Google AI Overview citations for competitive category terms, running rigorous site-health and schema audits, and building semantic content frameworks mapped to complex maintenance workflows.',
      'He applies that background to the field service software market at FieldServiceChoice on a simple principle: comparisons should work for the buyer, not the vendor. He oversees the site’s research and verification, keeping the Fit Scores independent of vendor payments, the pricing and integrations verified and dated against official sources, and the guidance honest about who a tool is wrong for, not just who it’s right for.',
    ],
    initials: 'AW',
    avatarColor: '#3f52e3',
